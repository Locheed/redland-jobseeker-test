...
module.exports = {
	...
	// Project options.
	projectURL: 'http://localhost/redlab-jobseeker/', // Local project URL of your already running WordPress site. Could be something like wpgulp.local or localhost:3000 depending upon your local WordPress setup.
	...
	// Watch files paths.
	watchStyles: './assets/sass/**/*.sass', // Path to all *.scss files inside css folder and inside them.
